...
for j=0.1:0.1:1
    ...
    for i=1:iter
        ...
        [ Data1,Data2,Data3,TX12,TX13,TX23 ] = Generate_dataset( n,nF1,nF2,nF3,rate,sigma1,sigma2,sigma3,param);
        if flag==0
            [ L1,L2,L3,indPM1,indPM2,indPM3 ] = Generate_laplacian_networks( nF1,nF2,nF3,ratio);
            flag=1;
        end
        [ H12,H13,H23 ] = Generate_associated_matrixH_P( Data1,Data2,Data3,indPM1,indPM2,indPM3);
        %run MGMMNC
...
%display AUC curve
param.P1='¦Ò';
plot_AUC_curve1( x,AUC12,AUC13,AUC23,param);
end
